...
WebUI.setText(findTestObject('Register/inpt_nama_lengkap'), '')

WebUI.setText(findTestObject('Register/inpt_email'), '')

WebUI.setText(findTestObject('Register/inpt_password'), '')
